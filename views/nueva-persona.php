...
<input type="text"  class="form-control"  id="razon_social" name="razon_social" required><br>
<br>
</div>
<div>
...
<input type="text"  class="form-control"  id="departamento" name="departamento" required><br>
<br>
</div>
<div>
<label for="provincia">provincia</label><br>
<input type="text"  class="form-control"  id="provincia" name="provincia" required><br>
<br>
</div>
<div>
<label for="distrito">distrito</label><br>
<input type="text"  class="form-control"  id="distrito" name="distrito" required><br>
<br>
</div>
<div>
<label for="cod_postal">cod_postal</label><br>
<input type="text"  class="form-control"  id="cod_postal" name="cod_postal" required><br>
<br>
</div>
<div>
<label for="direccion">direccion</label><br>
<textarea id="direccion"  class="form-control"  name="direccion" required></textarea><br>
<br>
</div>
<div>
